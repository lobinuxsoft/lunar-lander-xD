...
namespace CryingOnionTools.GravitySystem
{
    public class GravityBox : GravitySource
    {
        ...
        private void DrawGizmosOuterCube(float distance, Color color)
        {
            Vector3 a, b, c, d;
            ...
            Gizmos.color = new Color(color.r, color.g, color.b, .25f);
        ...
        private void OnDrawGizmos()
        {
            ...
            if (outerDistance > 0f)
            {
                DrawGizmosOuterCube(outerDistance, Color.yellow);
            }
            if (outerFalloffDistance > outerDistance)
            {
                DrawGizmosOuterCube(outerFalloffDistance, Color.cyan);
            }
        }
#endif
    }
